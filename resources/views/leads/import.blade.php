    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="choose-file form-group">
                ...
                <input type="hidden" class="form-control" name="table" id="table" value="leads">
            </div>
        </div>
    </div>
</div>
...
<div class="modal-footer">
    ...
    <a href="" data-url="" data-ajax-popup-over="true" title="{{ __('Create') }}" data-size="xl" data-title="{{ __('Import Lead CSV Data') }}"  class="d-none import_modal_show"></a>
</div>
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                else
                {
                    ...
                    setTimeout(function() {
                        SetData(data.output, data.fields);
                    }, 700);
                }
            }
        });
