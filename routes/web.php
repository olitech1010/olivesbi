...
Route::group(['middleware' => ['verified']], function () {
    ...
    Route::group(
        ...
        function () {
            ...
            Route::get('balance-sheet-report/{view?}/{collapseview?}', [ReportController::class, 'balplan_requestanceSheet'])->name('report.balance.sheet');
    ...
    Route::post('import/leads', [LeadController::class, 'leadImportdata'])->name('lead.import.data');
