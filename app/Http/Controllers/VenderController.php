    ...
    public function venderImportdata(Request $request)
    {
        ...
        foreach ($file_data as $key => $row) {
            ...
            try {
                ...
                $html .= '<td>' . $row[$request['balance']] . '</td>';
